            ...
            <div class="col-md-12">
                ...
                ?>
                    <div class="form-group">
                        ...
                        <input type="hidden" name="id_siswa" value="<?php echo $row['siswa_id']?>" class="form-control">
                        <input type="number" name="nis" value="<?php echo $row['id_siswa']?>" class="form-control">
                    </div>
